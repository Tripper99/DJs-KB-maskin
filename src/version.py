...
# Version history
VERSION_HISTORY = """
1.11.0 (2026-03-05): Alias support for newspaper names - Uses titles_bibids_aliases.csv for short names in PDF filenames, toggle via GUI checkbox. Fixed Python 3.13 trace_add compatibility.
