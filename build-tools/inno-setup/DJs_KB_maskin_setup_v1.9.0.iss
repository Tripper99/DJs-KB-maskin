; Inno Setup Script for DJs KB-maskin v1.9.0
...
AppVersion=1.9.0
AppVerName=DJs KB-maskin 1.9.0
...
OutputDir=..\..\dist
OutputBaseFilename=DJs_KB_maskin_v1.9.0_setup
...
Source: "..\..\dist\DJs_KB_maskin_v1.9.0.exe"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
; Start Menu shortcuts (user-level, no admin required)
Name: "{userprograms}\DJs KB-maskin\DJs KB-maskin"; Filename: "{app}\DJs_KB_maskin_v1.9.0.exe"; IconFilename: "{app}\Agg-med-smor-v4-transperent.ico"
Name: "{userprograms}\DJs KB-maskin\Manual"; Filename: "{app}\Manual.docx"
Name: "{userprograms}\DJs KB-maskin\Avinstallera DJs KB-maskin"; Filename: "{uninstallexe}"

; Desktop shortcut (optional, unchecked by default, user-level)
Name: "{userdesktop}\DJs KB-maskin"; Filename: "{app}\DJs_KB_maskin_v1.9.0.exe"; IconFilename: "{app}\Agg-med-smor-v4-transperent.ico"; Tasks: desktopicon

[Run]
; Launch application after installation (optional)
Filename: "{app}\DJs_KB_maskin_v1.9.0.exe"; Description: "Starta DJs KB-maskin"; Flags: nowait postinstall skipifsilent
...
begin
  ...
  begin
    ...
    begin
      ...
      OldDir := ExpandConstant('{localappdata}\Programs\DJs KB-maskin');
      if DirExists(OldDir) then
      begin
        // Remove old executables (keep config and logs)
        DeleteFile(OldDir + '\DJs_KB_maskin_v1.7.*.exe');
        DeleteFile(OldDir + '\DJs_KB_maskin_v1.8.*.exe');
      end;
    end;
  end;
end;
