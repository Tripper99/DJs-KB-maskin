...
#define MyAppExeName "DJs_KB_maskin_v1.7.4.exe"
#define MyAppCopyright "Copyright (C) 2025 Dan Josefsson"

; Define paths - using absolute paths for clarity
#define ProjectRoot "C:\Dropbox\Dokument\Programmering\Python\App DJs KB-maskin\DJs_KB_maskin (project)\"
...
OutputDir={#ProjectRoot}build-tools\output\installer
...
; CSV template (include the current CSV file as template)
Source: "{#ProjectRoot}titles_bibids_2025-09-09.csv"; DestDir: "{app}"; Flags: ignoreversion
...
Name: "{group}\CSV Mall för Bibkoder"; Filename: "{app}\titles_bibids_2025-09-09.csv"
  ...
  case CurPageID of
    wpWelcome:
      WizardForm.WelcomeLabel2.Caption := 
        ...
        'Version 1.7.4 innehåller en buggfix för filkonflikthantering och använder nu CSV istället för Excel för bib-kodmappning.' + #13#10 + #13#10 +
