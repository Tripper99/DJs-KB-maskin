...
#define MyAppExeName "DJs_KB_maskin_v1.7.6.exe"
  ...
  case CurPageID of
    wpWelcome:
      WizardForm.WelcomeLabel2.Caption := 
        ...
        '• Nedladdningar går nu till "Svenska tidningar" i din Nedladdningar-mapp' + #13#10 +
        '• Förbättrad mappvalidering när du startar bearbetning' + #13#10 +
        '• Möjlighet att välja ny mapp om vald mapp saknas' + #13#10 + #13#10 +
...
begin
  ...
  begin
    ...
    if MsgBox('Installation slutförd!' + #13#10 + #13#10 + 
              ...
              'Obs! Standardmappen för nedladdningar har ändrats till:' + #13#10 +
